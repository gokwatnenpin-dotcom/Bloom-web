  ...
  return (
    <main>
      <section className="bg-[#FDF0F2] px-[6%] py-16">
        ...
        <p className="text-[1.05rem] text-[#5A6660] font-sans max-w-[550px] leading-[1.7]">
          From joyful wildflowers to timeless roses, every arrangement is made to order and delivered fresh across Lagos.
        </p>
      </section>
