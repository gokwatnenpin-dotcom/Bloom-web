  ...
  return (
    <main>
      <section className="px-[6%] py-20 text-center">
        ...
        <p className="text-[1.05rem] text-[#5A6660] font-sans max-w-135 mx-auto leading-[1.7]">
      ...
      <section className="px-[6%] pb-20 grid grid-cols-1 md:grid-cols-2 gap-6">
        <a href="/shop" className="text-left bg-white border border-[#E6ECE8] rounded-2xl p-8 hover:border-[#E86A7C]">
            <h2 className="text-[1.6rem] text-[#1E4D3B] mt-5 mb-2">Birthday blooms</h2>
