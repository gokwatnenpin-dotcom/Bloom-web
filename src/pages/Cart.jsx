export default function Cart({ onNavigate }) {
  return (
    <main className="px-[6%] py-20 min-h-[65vh]">
      ...
      <p className="text-[1.05rem] text-[#5A6660] font-sans max-w-[480px] leading-[1.7] mb-8">
        Your cart is currently empty. Add a bouquet and we’ll have it wrapped fresh for delivery.
      </p>
      <a href="/shop" onClick={(event) => { event.preventDefault(); onNavigate("/shop"); }} className="inline-block bg-[#E86A7C] text-white px-8 py-[15px] rounded-xl text-[0.95rem] font-sans font-bold">Start shopping</a>
    </main>
  );
}
